    ...
    return (
        <div className="Menu">
            ...
            <div className="elementoMenu d-flex justify-content-start align-items-center">
                ...
                <a class='btnMen' href='/'><h3>Inicio</h3></a>
            </div>
            ...
            <div className="elementoMenu d-flex justify-content-start align-items-center">
                ...
                <a class='btnMen' href='/MensajeF' ><h3>Escribir mensaje</h3></a>
            </div>
            ...
            <div className="elementoMenu d-flex justify-content-start align-items-center">
                ...
                <a class='btnMen' href='https://www.facebook.com/'><h3>Ver | editar mensajes</h3></a>
            </div>
            ...
            <div className="elementoMenu d-flex justify-content-start align-items-center">
                ...
                <a class='btnMen' href='https://www.facebook.com/'><h3>Ver mi perfil</h3></a>
            </div>
