            ...
            <div className="container-fluid header">
                <div class="row">
                    ...
                    <div class="col-4 d-flex justify-content-end align-items-center">
                        ...
                        <h2 className="profileName">{sessionStorage.nombres + ' ' + sessionStorage.apellidos}<br /> <span className="profileNameTwo">{sessionStorage.apodo}</span></h2>
                    </div>
                </div>
            </div>
        )
        ...
        return (
            <div className="container-fluid header">
                <div class="row">
                    ...
                    <div class="col-4 d-flex justify-content-end align-items-center">
                        <img className="profilePic " src="https://i.postimg.cc/FFY3BtqH/OIP.jpg" alt=""/>
                        <h2 className="profileName"> <a href='/' style={{color: 'black', textDecoration: 'none'}}>Inicia sesión</a> <br /> <span className="profileNameTwo"><a href='/crearCuenta' style={{color: 'black', textDecoration: 'none'}}>Crea tu cuenta</a></span></h2>
                    </div>
                </div>
            </div>
        )
